...
\*\*File:\*\* `data/InternetSales\_StarSchema.xlsx`
...
\*\*File:\*\* `dashboard/Sales\_Analysis\_Dashboard.xlsb`  
...
!\[Detail Dashboard](docs/screenshots/detail\_dashboard.png)
...
│  └─ InternetSales\_StarSchema.xlsx

├─ dashboard/

│  └─ Sales\_Analysis\_Dashboard.xlsb
